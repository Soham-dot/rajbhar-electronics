      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-background border border-border text-white rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-accent placeholder:text-gray-500"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-background border border-border text-white rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-accent"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-background border border-border text-white rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-accent placeholder:text-gray-500 resize-none"
                />
              </div>
              <button
                type="submit"
                className="w-full bg-blue-accent hover:bg-blue-accent/90 text-white font-semibold py-3 rounded-lg transition-colors text-sm"
              >
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Map placeholder */}
            <div className="bg-card border border-border rounded-2xl overflow-hidden flex-1 min-h-[180px] relative">
