...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="bg-[#0d1424] py-20 border-y border-white/5">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-14 left-[12.5%] right-[12.5%] h-0.5 bg-gradient-to-r from-blue-600/30 via-blue-500/50 to-blue-600/30" />
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={step.title} className="relative flex flex-col items-center text-center">
                  {/* Step number bubble */}
                  <div className="relative z-10 w-14 h-14 rounded-full bg-blue-600 flex items-center justify-center mb-4 shadow-lg shadow-blue-900/40">
                    <Icon className="w-6 h-6 text-white" />
                    <span className="absolute -top-1 -right-1 w-5 h-5 bg-[#0d1424] border border-blue-500 rounded-full text-xs text-blue-400 font-bold flex items-center justify-center">
                      {index + 1}
                    </span>
                  </div>
