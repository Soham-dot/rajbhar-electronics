...
export default function Reviews() {
  return (
    <section id="reviews" className="bg-[#0a0f1a] py-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {reviews.map((review) => (
            <div
              key={review.name}
              className="bg-[#111827] border border-white/10 rounded-2xl p-6 hover:border-blue-500/20 transition-colors"
            >
              <div className="flex items-start justify-between mb-4">
                <div>
                  <p className="font-bold text-white">{review.name}</p>
                  <p className="text-xs text-gray-500 mt-0.5">{review.tvBrand}</p>
                </div>
        ...
        <div className="mt-10 text-center">
          <div className="inline-flex items-center gap-3 bg-[#111827] border border-white/10 rounded-2xl px-6 py-4">
            ...
            <div className="text-left">
              <p className="text-white font-bold text-lg">4.8 out of 5</p>
              <p className="text-gray-500 text-xs">Based on 850+ Google reviews</p>
            </div>
          </div>
        </div>
      </div>
