        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.title}
                className="bg-card border border-border rounded-2xl p-6 hover:border-blue-accent/30 hover:shadow-lg hover:shadow-blue-accent/10 transition-all group"
              >
                <div className="w-12 h-12 bg-blue-accent/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-blue-accent/20 transition-colors">
                ...
                <a
                  href="#contact"
                  className="text-blue-accent hover:text-blue-accent/80 text-sm font-medium transition-colors"
                >
                  Learn More →
                </a>
              </div>
